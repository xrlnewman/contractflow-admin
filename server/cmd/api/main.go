...
import (
	...
	"github.com/xrlnewman/contractflow-admin/server/internal/platform/database"
	"github.com/xrlnewman/contractflow-admin/server/internal/platform/store"
	"github.com/xrlnewman/contractflow-admin/server/internal/transport/httpapi"
)
...
func main() {
	...
	defer stop()
	go func() {
		slog.Info("ContractFlow API 已启动", "addr", cfg.Addr)
